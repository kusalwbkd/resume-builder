...
export async function POST(req:NextRequest){
    ...
    Important:
    Return only a **JSON array of exactly 5 bullet point strings**, like this:
    ...
    Do **not** provide any additional text, explanation, formatting, or narrative. Just return the JSON array of bullet points as shown above.
    `;
