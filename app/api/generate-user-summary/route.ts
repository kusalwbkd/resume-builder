...
export async function POST(req:NextRequest){
    ...
    **Important: ONLY return the result in the following JSON format:**
    {
      "about_me": "Your final summary here as a single string."
    }
    
    Do not include any additional text, comments, or explanation. Return only the JSON object.
    `;
